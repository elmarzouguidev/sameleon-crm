<div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @include('theme.pages.Commercial.BR.__edit.__info')
                    ...
                    <div class="row" id="articles_list">
                        <div class="col-lg-12 mb-4">
                            ...
                            @if ($command->articles->count() <= 0)
                                @include('theme.pages.Commercial.BR.__edit.__add_articles')
                            @else
                                @include('theme.pages.Commercial.BR.__edit.__edit_articles')
                            @endif
                        </div>
                        <div class="col-lg-6">
    ...
    <div class="col-lg-4">
        @include('theme.pages.Commercial.BR.__edit.__bc_actions')
    </div>
</div>

@include('theme.pages.Commercial.BR.__datatable.__send_bc' )

@include('theme.pages.Commercial.BR.__edit.__print_document')
