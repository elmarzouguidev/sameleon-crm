    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="addEmail" id="addEmail" action="{{route('commercial:providers.add.emails',$provider->uuid)}}"
                      method="post">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        @foreach($provider->emails as $email)
                                            ...
                                            <div class="col-lg-3">
                                                <button
                                                    type="button"
                                                    class="deleteProviderEmail btn btn-danger waves-effect waves-light"
                                                    data-provider="{{ $provider->uuid }}" data-email="{{ $email->uuid }}"
                                                >
                                                    supprimer
                                                </button>
                                            </div>
